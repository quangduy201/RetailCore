    ...
    public partial class ExpandProductCatalog : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductVariantAttributes", x => new { x.ProductVariantId, x.ProductAttributeValueId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantImages_ProductVariantId_SortOrder",
